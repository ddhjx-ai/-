...
<template>
  <div>
    <van-nav-bar title="标识码注册" @click-left="onClickLeft" :border="false">
    ...
    >
      ...
      <img :src="scanImg" style="width: 0.23rem;margin-left: -0.4rem;z-index:999;" @click="onClickLeft" />
    ...
    >
      本月
      <span style="margin-left:2.5rem;color:#888888 ;font-size:12px;">注册量：5</span>
    </div>
